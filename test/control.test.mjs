...
check(!shipped.paused && !shipped.readOnly && FEATURES.every((f) => modeOf(shipped, f) === (["tickerWatch", "leakWatch", "threatWatch"].includes(f) ? "shadow" : "on")), "the shipped control.json: everything on, the new watches in shadow");
