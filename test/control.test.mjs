...
check(!shipped.paused && !shipped.readOnly && FEATURES.every((f) => modeOf(shipped, f) === (f === "tickerWatch" ? "shadow" : "on")), "the shipped control.json: everything on, the new ticker watch in shadow");
