...
check(grantRisk({ kind: "erc20", amount: U, spenderIsContract: true, spenderLabel: "0x AllowanceHolder", flagged: ["phishing activities"] }).level === "medium", "known infrastructure listed by a reputation feed: shown, not escalated to critical");
