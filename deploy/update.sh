...
cd "$TMP"
for t in test/v4hooks.test.mjs test/sim.test.mjs test/txsim.test.mjs test/features.test.mjs test/talk.test.mjs test/control.test.mjs test/outbox.test.mjs test/holders.test.mjs test/store.test.mjs test/provenance.test.mjs test/voice.test.mjs test/sentinel.test.mjs; do
  [ -f "$t" ] || continue
