...
function quoteDepth(liquidity, sqrtPriceX96, quoteIs1, quoteDecimals) {
...
function priceFromSqrt(sqrtPriceX96, dec0, dec1, tokenIs0) {
 ...
 */
async function discoverV4Pools(rpc, token) {
...
return { keccak256, INIT_TOPIC, PERMISSIONS, permissionsOf, poolIdOf, keyFromLog, makeV4Hooks, isV4, hookLine, slot0SlotOf, quoteDepth, priceFromSqrt, discoverV4Pools };
})();
