...
description: |
  ...
  "good entry right now?", "which contract is the real $TICKER", "is this a fake / twin token", "can I exit this size", "how much can I sell without moving the price", "how big should my position be". One call returns a machine-readable verdict (OK / CAUTION / DANGER),
